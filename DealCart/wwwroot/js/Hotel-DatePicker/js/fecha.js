!(function (t, n) {
    "object" == typeof exports && "undefined" != typeof module ? n(exports) : "function" == typeof define && define.amd ? define(["exports"], n) : n((t.fecha = {}));
})(this, function (t) {
    "use strict";
    ...
    var i = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
        ...
        b = function (t, e, o) {
            if ((void 0 === e && (e = v.default), void 0 === o && (o = {}), "number" == typeof t && (t = new Date(t)), "[object Date]" !== Object.prototype.toString.call(t) || isNaN(t.getTime())))
    ...
    function w(t, e, o) {
        ...
        var u = { year: new Date().getFullYear(), month: 0, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0, isPm: null, timezoneOffset: null },
            i = [],
            d = [],
        ...
        if ((1 === u.isPm && null != u.hour && 12 != +u.hour ? (u.hour = +u.hour + 12) : 0 === u.isPm && 12 == +u.hour && (u.hour = 0), null == u.timezoneOffset)) {
